...
namespace Coinium.Core.Server.Stratum
{
    ...
    public class StratumService : JsonRpcService, IRPCService
    {
        ...
        public SubscribeResponse SubscribeMiner(string signature)
        {
            ...
            {
                ExtraNonce1 = this.Pool.JobManager.ExtraNonce.NextExtraNonce().ToString("x8"), // Hex-encoded, per-connection unique string which will be used for coinbase serialization later. (http://mining.bitcoin.cz/stratum-mining)
