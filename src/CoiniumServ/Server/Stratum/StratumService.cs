...
namespace Coinium.Server.Stratum
{
    ...
    public class StratumService : JsonRpcService, IRpcService
    {
        ...
        public SubscribeResponse SubscribeMiner(string signature)
        {
            ...
            {
                ExtraNonce1 = _jobManager.ExtraNonce.NextExtraNonce().ToString("x8"), // Hex-encoded, per-connection unique string which will be used for coinbase serialization later. (http://mining.bitcoin.cz/stratum-mining)
        ...
        public bool SubmitWork(string user, string jobId, string extranNonce2, string nTime, string nonce)
        {
            ...
            return _shareManager.ProcessShare(miner, jobId, extranNonce2, nTime, nonce);
        }
    }
}
