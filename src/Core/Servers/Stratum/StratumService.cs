...
using Coinium.Core.Servers.Stratum.Responses;
...
namespace Coinium.Core.Servers.Stratum
{
    ...
    public class StratumService : JsonRpcService
    {
        ...
        {
            var rndGenerator = System.Security.Cryptography.RandomNumberGenerator.Create();
            var randomBytes = new byte[4];
            rndGenerator.GetNonZeroBytes(randomBytes);
            this.InstanceId = BitConverter.ToUInt32(randomBytes, 0);
        ...
        {
            this.ExtraNonceCounter = InstanceId << 27;  // init the ExtraNonce counter.
        }
        ...
        public SubscribeResponse SubscribeMiner(string signature)
        {
            ...
            var response = new SubscribeResponse
            {
                ...
                ExtraNonce2Size = 0x4 // Represents expected length of extranonce2 which will be generated by the miner. (http://mining.bitcoin.cz/stratum-mining)
            };
