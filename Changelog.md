...
Mining
* Improved SocketServiceContext and removed unneccisary overhead.
...
* Fixed a bug with stratum-miner packet logger where it was emiting normal log messages.
...
* BlockProcessor will now also honor oprhan blocks with -1 confirmations.
